...
{
	std::cout << this->_name << "ClapTrap : Assignment Operator Call" << std::endl;
	if (this == &rhs)
		return (*this);
...
void	ClapTrap::takeDamage(unsigned	int	amount)
{
	...
	std::cout << "ClapTrap : " << this->_name << " take < " << amount << " > of damege!!!" << std::endl;
	std::cout << "ClapTrap : " << this->_name << " have < " << this->_hitPoint << " > of hitpoint left" << std::endl;
}
